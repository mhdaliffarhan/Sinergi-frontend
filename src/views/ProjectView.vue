  ...
  <div>
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
      ...
      <div class="mt-4 sm:mt-0 flex items-center gap-2">
        ...
        <button v-if="authStore.user?.isKetuaTim || authStore.isOperator" @click="openModal" class="flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 transition-colors">
          <span>+</span>
