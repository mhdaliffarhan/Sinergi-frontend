<template>
  <div
    class="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-gray-900"
  >
    <!-- BACKGROUND & OVERLAY -->
    <div class="absolute inset-0 z-0 overflow-hidden">
      ...
      <div
        class="absolute inset-0 bg-gradient-to-br from-blue-900/90 via-green-900/90 to-yellow-900/80 backdrop-blur-sm"
      ></div>
    </div>
    ...
    <!-- Blob Biru (Kiri Atas) -->
    <div
      class="absolute top-[-10%] left-[-10%] w-96 h-96 bg-blue-500/40 rounded-full blur-3xl animate-pulse"
    ></div>
    <!-- Blob Hijau (Kanan Atas/Tengah) -->
    <div
      class="absolute top-[20%] right-[-10%] w-80 h-80 bg-green-500/30 rounded-full blur-3xl animate-pulse delay-700"
    ></div>
    <!-- Blob Kuning (Bawah) -->
    <div
      class="absolute bottom-[-10%] left-[20%] w-96 h-96 bg-yellow-500/30 rounded-full blur-3xl animate-pulse delay-1000"
    ></div>
    ...
    >
      ...
      <div class="text-center mb-8">
        <div
          class="inline-block p-3 rounded-full bg-gradient-to-br from-blue-50 to-green-50 dark:from-gray-700 dark:to-gray-600 mb-4 shadow-sm"
        >
          <img class="h-16 w-auto" src="/logo.png" alt="Logo" />
        </div>
        <h2
          class="text-2xl sm:text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight"
        >
          Selamat Datang
        </h2>
      ...
      <transition name="fade">
        <div
          v-if="errorMessage"
          class="mb-6 p-4 bg-red-50 dark:bg-red-900/30 border-l-4 border-red-500 rounded-r-lg flex items-start gap-3"
        >
          <svg
      ...
      <form class="space-y-6" @submit.prevent="handleSubmit">
        ...
        <div class="space-y-1">
          <label
            for="username"
            class="block text-sm font-medium text-gray-700 dark:text-gray-300 ml-1"
            >Username</label
          >
          <div class="relative group">
            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <svg
                class="h-5 w-5 text-gray-400 group-focus-within:text-blue-600 transition-colors"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            <input
              ...
              v-model="username"
              required
              class="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-900/50 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 hover:border-green-400 dark:hover:border-green-500 transition-all sm:text-sm"
        ...
        <div class="space-y-1">
          ...
          <div class="relative group">
            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <svg
                class="h-5 w-5 text-gray-400 group-focus-within:text-green-600 transition-colors"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            <input
              ...
              v-model="password"
              required
              class="block w-full pl-10 pr-10 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-900/50 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:border-green-500 hover:border-green-400 dark:hover:border-green-500 transition-all sm:text-sm"
            ...
            >
              ...
              <svg v-else class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path
                  ...
                  stroke-linejoin="round"
                  stroke-width="2"
                  d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a10.059 10.059 0 013.999-5.325m-3.641-3.641L21 21m-2.458-6.138A10.05 10.05 0 0012 5c-1.39 0-2.733.29-3.953.815"
                />
                <path
                  stroke-linecap="round"
                  stroke-linejoin="round"
        ...
        <div class="flex items-center justify-between pt-2">
          <div class="flex items-center">
            ...
            <label
              for="remember-me"
              class="ml-2 block text-sm text-gray-700 dark:text-gray-300 cursor-pointer select-none group"
            >
