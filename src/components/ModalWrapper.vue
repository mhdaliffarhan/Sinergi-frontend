<template>
  <Teleport to="body">
    <Transition name="modal-fade">
      <div v-if="show" class="fixed inset-0 z-[999] flex items-center justify-center p-4 sm:p-6">
        <!-- Backdrop -->
        <div 
        ...
        <!-- Modal Content -->
        <div class="relative w-full sm:max-w-2xl bg-white dark:bg-gray-800 rounded-2xl shadow-2xl flex flex-col max-h-[90vh] transform transition-all border border-gray-100 dark:border-gray-700">
...
const handleKeydown = (e) => {
  if (props.show && e.key === 'Escape' && !props.preventClose) {
    emit('close');
  }
};
